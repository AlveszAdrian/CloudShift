...
function IAMSecurityPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "IAMSecurityPage.useEffect": ()=>{
            ...
            try {
                ...
                const securityCache = localStorage.getItem('iamSecurityChecks');
                const cachedCredentialId = localStorage.getItem('iamSecurityLastCredentialId');
                if (securityCache && cachedCredentialId === selectedCredential.id) {
                    ...
                    const lastUpdateTime = localStorage.getItem('iamSecurityLastUpdateTime');
                    if (lastUpdateTime) {
    ...
    const fetchSecurityIssuesInBackground = async ()=>{
        ...
        try {
            ...
            const response = await fetch(`/api/aws/iam/security?credentialId=${selectedCredential.id}`);
            if (!response.ok) {
                throw new Error("Erro na atualização em background");
            }
            const data = await response.json();
            // Processar os problemas de segurança - Focados em IAM
            ...
            const mappedIssues = issues.map((issue)=>({
                    ...
                    recommendation: issue.description.includes("permissivas") ? "Revise e limite as permissões IAM apenas ao necessário" : "Revise as configurações de segurança deste recurso"
                }));
            ...
            const passedChecks = [
                {
                    id: "sec-4",
                    title: "Políticas de senha fortes",
                    description: "As políticas de senha para usuários IAM estão configuradas adequadamente",
                    status: "passed",
                    resourceType: "IAM",
                    impact: "high",
                    recommendation: "Continue a monitorar e atualizar a política de senhas conforme necessário"
                },
                {
                    id: "sec-5",
                    title: "Credenciais IAM não utilizadas",
                    description: "Não foram encontradas credenciais IAM sem uso por mais de 90 dias",
                    status: "passed",
                    resourceType: "IAM",
                    impact: "medium",
                    recommendation: "Continue a monitorar e remover credenciais não utilizadas"
                }
            ];
            const finalChecks = [
                ...allChecks,
            ...
            // Salvar no cache
            localStorage.setItem('iamSecurityChecks', JSON.stringify(finalChecks));
            localStorage.setItem('iamSecurityLastCredentialId', selectedCredential.id);
            localStorage.setItem('iamSecurityLastUpdateTime', Date.now().toString());
            console.log("Atualização em background de verificações de segurança IAM concluída");
        } catch (err) {
    ...
    const fetchSecurityIssues = async ()=>{
        ...
        try {
            ...
            // Buscar problemas de segurança reais - Focado em IAM
            const response = await fetch(`/api/aws/iam/security?credentialId=${selectedCredential.id}`);
            if (!response.ok) {
                const errorData = await response.json();
                throw new Error(errorData.error || "Erro ao buscar problemas de segurança IAM");
            }
            const data = await response.json();
            ...
            console.error("Erro ao buscar problemas de segurança IAM:", err);
            setError(err instanceof Error ? err.message : "Erro ao buscar problemas de segurança IAM");
            setScanning(false);
            setLoading(false);
        }
    };
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: "Gerencie e monitore a segurança dos usuários, grupos e políticas IAM."
                    }, void 0, false, {
                        fileName: "[project]/src/app/dashboard/iam/page.tsx",
                        lineNumber: 368,
                        columnNumber: 9
            ...
            !selectedCredential ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$framer$2d$motion$2f$dist$2f$es$2f$render$2f$components$2f$motion$2f$proxy$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["motion"].div, {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                    ...
                    children: "Selecione uma credencial AWS para começar a análise de segurança IAM."
                }, void 0, false, {
                    fileName: "[project]/src/app/dashboard/iam/page.tsx",
                    lineNumber: 382,
                    columnNumber: 11
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                }, void 0, true) : "Verificar Segurança IAM"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/iam/page.tsx",
                                                lineNumber: 451,
                                                columnNumber: 17
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                ...
                                                children: "Gerenciar Usuários e Grupos"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/iam/page.tsx",
                                                lineNumber: 468,
                                                columnNumber: 17
                                ...
                                children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Carregando verificações de segurança IAM..."
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/dashboard/iam/page.tsx",
                                            lineNumber: 526,
                                            columnNumber: 19
...
_s(IAMSecurityPage, "jJsGQoWWNf+K7L/ErxR3xizHGBw=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAwsCredentials$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAwsCredentials"]
    ];
});
_c = IAMSecurityPage;
var _c;
__turbopack_context__.k.register(_c, "IAMSecurityPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=_d188449e._.js.map