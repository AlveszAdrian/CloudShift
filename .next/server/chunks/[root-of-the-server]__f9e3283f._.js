...
async function GET(request) {
    ...
    try {
        ...
        if (afterId) {
            ...
            const referenceAlert = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findUnique({
                where: {
                    id: afterId
                },
                select: {
            ...
            if (!referenceAlert) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'Alerta de referência não encontrado'
                }, {
                    status: 404
                });
            }
            // Buscar todos os alertas mais recentes que o alerta de referência
            const newerAlerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findMany({
                where: {
                    createdAt: {
        ...
        const alerts = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAlerts"])({
            ...status && {
                status
            },
            ...severity && {
...
async function PATCH(request) {
    ...
    try {
        ...
        if (!id || !action) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ID do alerta e ação são obrigatórios'
            }, {
                status: 400
            });
        }
        if (action === 'dismiss') {
            const alert = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["dismissAlert"])(id);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                alert
            });
        }
        if (action === 'resolve') {
            const alert = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["resolveAlert"])(id);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                alert
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f9e3283f._.js.map