...
"[project]/.next-internal/server/app/api/aws/credentials/[id]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/aws/credentials/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PATCH(request, { params }) {
    ...
    try {
        ...
        const existingCredential = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.findUnique({
            where: {
                id,
                userId: session.user.id
            }
        ...
        const updatedCredential = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.update({
            where: {
                id
            },
            data: {
...
async function DELETE(request, { params }) {
    ...
    try {
        ...
        const alertsBeforeDeletion = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findMany({
            where: {
                credentialId: id
            },
            select: {
        ...
        console.log(`Tipos de recursos encontrados: ${[
            ...new Set(alertsBeforeDeletion.map((a)=>a.resourceType))
        ].join(', ')}`);
        // Verificar especificamente alertas de EC2
        const ec2Alerts = alertsBeforeDeletion.filter((a)=>a.resourceType === 'EC2Instance' || a.resourceType === 'SecurityGroup' || a.resourceType === 'Volume' || a.resourceType.includes('VPC') || a.resourceType.includes('Network') || a.resourceType === 'NetworkACL' || a.resourceType.includes('ACL') || a.resourceType === 'ElasticIP' || a.resourceType === 'RouteTable' || a.resourceType === 'Subnet');
        console.log(`Alertas de EC2 e rede encontrados: ${ec2Alerts.length}`);
        // Verificar especificamente alertas de IAM
        const iamAlerts = alertsBeforeDeletion.filter((a)=>a.resourceType === 'IAMUser' || a.resourceType === 'IAMAccessKey' || a.resourceType === 'SecretManagerSecret' || a.resourceType === 'IAMPolicy' || a.resourceType === 'IAMGroup' || a.resourceType === 'IAMPasswordPolicy');
        ...
        const deletedEC2Alerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.deleteMany({
            where: {
                credentialId: id,
                OR: [
                    {
        ...
        const deletedIAMAlerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.deleteMany({
            where: {
                credentialId: id,
                OR: [
                    {
        ...
        const deletedRemainingAlerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.deleteMany({
            where: {
                credentialId: id
            }
        });
        ...
        const alertsAfterDeletion = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findMany({
            where: {
                credentialId: id
            }
        });
        ...
        if (alertsAfterDeletion.length > 0) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].$executeRaw`DELETE FROM "Alert" WHERE "credentialId" = ${id}`;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2b37dab._.js.map