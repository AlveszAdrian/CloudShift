...
"[project]/.next-internal/server/app/api/aws/iam/users/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
class AwsClientManager {
    ...
    constructor(credentials){
        ...
        try {
            ...
            try {
                console.log('Criando cliente IAM...');
                ...
                console.log('Cliente IAM criado com sucesso');
            } catch (error) {
                console.error('Erro ao criar cliente IAM:', error);
                throw new Error('Falha ao criar cliente IAM');
            }
            ...
            throw error; // Re-throw para que o erro seja capturado no getInstance
        }
    }
    ...
    getIAMClient() {
        if (!this.iamClient) {
            console.error('Cliente IAM não inicializado');
            throw new Error('Cliente IAM não disponível');
        }
...
class IAMService {
    ...
    async updateAccessKeyStatus(username, accessKeyId, status) {
        try {
...
"[project]/src/lib/aws-services/index.ts [app-route] (ecmascript) <locals>": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/aws-services/index.ts [app-route] (ecmascript) <module evaluation>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$ec2$2d$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-services/ec2-security-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$vulnerability$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-services/vulnerability-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/aws-services/index.ts [app-route] (ecmascript) <locals>");
}}),
"[project]/src/app/api/aws/iam/users/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$module__evaluation$3e$__ = __turbopack_context__.i("[project]/src/lib/aws-services/index.ts [app-route] (ecmascript) <module evaluation>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/lib/aws-services/index.ts [app-route] (ecmascript) <locals>");
;
;
;
...
async function GET(request) {
    try {
        ...
        // Obter serviço IAM
        const awsService = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["getIAMService"])(credentialId);
        if (!awsService) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const usersWithDetails = await Promise.all(iamUsers.map(async (user)=>{
            try {
...
async function PATCH(request) {
    try {
        ...
        if (action === 'attachPolicy') {
            ...
            await awsService.attachUserPolicy(userName, policyArn);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Política anexada com sucesso'
            });
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Política desanexada com sucesso'
            });
        } else {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c500eec4._.js.map