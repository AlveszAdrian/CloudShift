...
"[project]/.next-internal/server/app/api/aws/credentials/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/aws/credentials/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function validateAwsCredentials(accessKeyId, secretKey, region) {
    try {
...
async function GET() {
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(credentials.map((credential)=>({
                id: credential.id,
...
async function POST(request) {
    ...
    try {
        ...
        const credential = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.create({
            data: {
                name,
                accessKeyId,
                secretKey,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fa842da3._.js.map