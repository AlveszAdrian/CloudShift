...
"[project]/src/lib/data/aws-pagination.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "IAMPaginator": (()=>IAMPaginator),
    "S3Paginator": (()=>S3Paginator),
    "paginateAWSRequest": (()=>paginateAWSRequest)
});
...
async function paginateAWSRequest(fetcher, getItems, getNextToken, setNextToken, initialRequest, options = DEFAULT_PAGINATION_OPTIONS) {
    const results = [];
    let currentRequest = {
        ...initialRequest
    };
...
const S3Paginator = {
    listObjectsV2: async (s3Client, params, options)=>{
        return paginateAWSRequest((req)=>s3Client.listObjectsV2(req).promise(), (res)=>res.Contents, (res)=>res.NextContinuationToken, (req, token)=>({
                ...req,
...
const IAMPaginator = {
    listUsers: async (iamClient, params = {}, options)=>{
        return paginateAWSRequest((req)=>iamClient.listUsers(req).promise(), (res)=>res.Users, (res)=>res.Marker, (req, token)=>({
                ...req,
                Marker: token
            }), params, options);
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$repositories$2f$aws$2d$credential$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/repositories/aws-credential-repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$aws$2d$pagination$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/data/aws-pagination.ts [app-route] (ecmascript)");
;
;
;
class IAMService {
    ...
    async getUsers(credentialId) {
        ...
        try {
            ...
            // Usar o paginador para obter todos os usuários
            const iamUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$aws$2d$pagination$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IAMPaginator"].listUsers(iamClient, {}, {
                maxPages: 5
            });
            // Processar cada usuário para obter detalhes adicionais
            const users = await Promise.all(iamUsers.map(async (user)=>{
                try {
                    ...
                    return {
                        ...
                        riskLevel: this.calculateRiskLevel(hasConsoleAccess, hasMfa, accessKeys.AccessKeyMetadata?.length || 0)
                    };
                } catch (error) {
    ...
    // Movido para o serviço como lógica de negócio
...
(()=>{
    const e = new Error("Cannot find module './services/s3-service'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module './services/security-service'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b34af7ef._.js.map