...
async function POST(request) {
    ...
    try {
        ...
        console.log('Iniciando verificação de segurança para EC2...');
        // Simular verificação de segurança do EC2
        // Em um cenário real, você chamaria um serviço específico como:
        // const ec2SecurityService = new EC2SecurityService({...credential});
        // const securityIssues = await ec2SecurityService.scanSecurityIssues();
        // Por enquanto, simularemos alguns problemas comuns para demonstrar a funcionalidade
        const mockIssues = [
            {
                title: 'Grupo de segurança com porta 22 aberta para internet',
                description: 'O grupo de segurança permite conexões SSH (porta 22) de qualquer origem (0.0.0.0/0), o que representa um risco de segurança.',
                severity: 'HIGH',
                resourceId: 'sg-example1',
                resourceType: 'SecurityGroup'
            },
            {
                title: 'Instância EC2 sem tags obrigatórias',
                description: 'A instância não possui as tags obrigatórias para conformidade com a política interna (Owner, Environment).',
                severity: 'MEDIUM',
                resourceId: 'i-example1',
                resourceType: 'EC2Instance'
            },
            {
                title: 'Volume EBS não criptografado',
                description: 'O volume EBS não está utilizando criptografia, o que pode expor dados sensíveis.',
                severity: 'HIGH',
                resourceId: 'vol-example1',
                resourceType: 'Volume'
            },
            {
                title: 'Instância EC2 com configuração IMDSv1',
                description: 'A instância está usando IMDSv1, que é menos seguro que o IMDSv2. Recomenda-se migrar para IMDSv2 para mitigar riscos de SSRF.',
                severity: 'MEDIUM',
                resourceId: 'i-example2',
                resourceType: 'EC2Instance'
            },
            {
                title: 'Grupo de segurança permite tráfego irrestrito',
                description: 'O grupo de segurança permite tráfego de entrada irrestrito (0.0.0.0/0) em portas não essenciais.',
                severity: 'CRITICAL',
                resourceId: 'sg-example2',
                resourceType: 'SecurityGroup'
            }
        ];
        ...
        console.log(`Criados ${createdAlerts.length} alertas de segurança para EC2`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: `Verificação de segurança do EC2 concluída. Encontrados ${mockIssues.length} problemas de segurança.`,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c76b99b9._.js.map