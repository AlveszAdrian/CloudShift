...
class IAMService {
    ...
    async deleteGroup(groupName) {
        try {
            await this.iamClient.deleteGroup({
                GroupName: groupName
            }).promise();
        } catch (error) {
    ...
    async listUsersInGroup(groupName) {
        try {
            const response = await this.iamClient.getGroup({
                GroupName: groupName
            }).promise();
    ...
    async listAttachedGroupPolicies(groupName) {
        try {
            const result = await this.iamClient.listAttachedGroupPolicies({
                GroupName: groupName
            }).promise();
    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                const passwordValid = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["compare"])(credentials.password, user.passwordHash);
                if (!passwordValid) {
                    throw new Error("Senha incorreta");
                }
                return {
...
async function getIAMClient(credentialId) {
    const awsService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AwsService"]();
    const credential = await awsService.getCredential(credentialId);
    if (!credential) {
        throw new Error('Credencial não encontrada');
    }
    const clientManager = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AwsClientManager"]({
...
async function GET(request) {
    try {
        ...
        const auth = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAuth"])();
        if (!auth) {
        ...
        if (!credentialId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ID de credencial não fornecido'
            }, {
                status: 400
            });
        }
        ...
        console.error('Erro ao listar usuários IAM:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao listar usuários IAM'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        if (!credentialId || !userName) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ID de credencial e nome de usuário são obrigatórios'
            }, {
                status: 400
            });
        }
        // Obter cliente IAM
        const { clientManager, awsService } = await getIAMClient(credentialId);
        const iamService = clientManager.getIamService();
        // Criar usuário
        const newUser = await iamService.createUser(userName);
        ...
        if (policies && Array.isArray(policies) && policies.length > 0) {
            for (const policyArn of policies){
                await iamService.attachUserPolicy(userName, policyArn);
            }
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: newUser
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao criar usuário IAM'
        }, {
            status: 500
        });
    }
    ...
    try {
        ...
        if (removePolicies && Array.isArray(removePolicies) && removePolicies.length > 0) {
            for (const policyArn of removePolicies){
                await iamService.detachUserPolicy(userName, policyArn);
            }
        }
        // Obter usuário atualizado
        const updatedUser = await iamService.getUser(userName);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            user: updatedUser
        });
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao atualizar usuário IAM'
        }, {
            status: 500
        });
    }
...
async function DELETE(request) {
    try {
        ...
        const { clientManager } = await getIAMClient(credentialId);
        const iamService = clientManager.getIamService();
        // Remover usuário e suas dependências
        await iamService.deleteUser(userName);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true
        });
    } catch (error) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao excluir usuário IAM'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1c776fb6._.js.map