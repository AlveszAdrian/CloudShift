...
(()=>{
    const e = new Error("Cannot find module '@/lib/models/aws-credential'");
...
async function GET(request) {
    try {
        ...
        if (!credentialId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'ID de credencial é obrigatório'
            }, {
                status: 400
            });
        }
        ...
        const awsService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](credential);
        // Get roles
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: error instanceof Error ? error.message : 'Erro desconhecido ao buscar funções IAM'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        const { credentialId, roleName, description } = body;
        if (!credentialId || !roleName) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'ID de credencial e nome da função são obrigatórios'
            }, {
                status: 400
            });
        }
        ...
        const awsService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"](credential);
        // Create role
        const role = await awsService.createRole(roleName, description);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: error instanceof Error ? error.message : 'Erro desconhecido ao criar função IAM'
        }, {
            status: 500
        });
    }
...
async function DELETE(request) {
    try {
        ...
        const attachedPolicies = await awsService.listRolePolicies(roleName);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Função IAM excluída com sucesso'
        });
    } catch (error) {
        console.error('Error deleting IAM role:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: error instanceof Error ? error.message : 'Erro desconhecido ao excluir função IAM'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5477670b._.js.map