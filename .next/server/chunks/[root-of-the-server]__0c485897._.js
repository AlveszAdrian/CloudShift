...
"[project]/.next-internal/server/app/api/aws/testIam/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
(()=>{
    const e = new Error("Cannot find module '@aws-sdk/client-iam'");
...
class IAMService {
    ...
    async listGroups() {
        try {
            const response = await this.iamClient.send(new ListGroupsCommand({}));
    ...
    async createGroup(groupName) {
        try {
            const response = await this.iamClient.send(new CreateGroupCommand({
                GroupName: groupName
            }));
            return {
    ...
    async deleteGroup(groupName) {
        try {
            await this.iamClient.send(new DeleteGroupCommand({
                GroupName: groupName
            }));
        } catch (error) {
    ...
    async removeUserFromGroup(userName, groupName) {
        try {
            await this.iamClient.send(new RemoveUserFromGroupCommand({
                UserName: userName,
                GroupName: groupName
            }));
        } catch (error) {
    ...
    async listAttachedGroupPolicies(groupName) {
        try {
            const response = await this.iamClient.send(new ListAttachedGroupPoliciesCommand({
                GroupName: groupName
            }));
...
"[project]/src/app/api/aws/testIam/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const credential = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.findFirst();
        if (!credential) {
        ...
        const users = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getIamUsers"])(credential.id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0c485897._.js.map