...
"[project]/.next-internal/server/app/api/aws/debug/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/aws/debug/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        const diagnosticInfo = {
            system: {
                ...
                aws_sdk_version: __turbopack_context__.r("[project]/node_modules/aws-sdk/package.json (json)").version
            },
            credentials: []
        };
        // Buscar credenciais do usuário
        const credentials = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.findMany({
            where: {
        ...
        for (const credential of credentials){
            ...
            // Testar EC2
            try {
                const ec2 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].EC2(config);
                const ec2Result = await ec2.describeInstances().promise();
                const instanceCount = ec2Result.Reservations?.reduce((count, reservation)=>count + (reservation.Instances?.length || 0), 0) || 0;
                credInfo.tests.ec2 = {
                    status: 'success',
            ...
            // Testar S3
            try {
                const s3 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].S3(config);
            ...
            // Testar GuardDuty
            try {
                const guardDuty = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].GuardDuty(config);
        ...
        const anyServiceWorking = diagnosticInfo.credentials.some((cred)=>cred.tests.ec2.status === 'success' || cred.tests.s3.status === 'success' || cred.tests.guardduty.status === 'success');
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(diagnosticInfo);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__fdfd0160._.js.map