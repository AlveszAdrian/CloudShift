...
"[project]/.next-internal/server/app/api/alerts/scan/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "7169abf443e428d29f0e97836b73464dc2a0478a22cdc5c5f4a6bf5f4f2f1fb2",
    "copyEngine": true
};
...
"[project]/src/lib/aws-client.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/aws-sdk/lib/aws.js [app-route] (ecmascript)");
;
class AwsClientManager {
    static instances = new Map();
    static cleanupInterval = null;
    static DEFAULT_CLEANUP_INTERVAL = 30 * 60 * 1000;
    static DEFAULT_INSTANCE_TTL = 60 * 60 * 1000;
    credentials;
    cloudWatchClient;
    ec2Client;
    s3Client;
    ...
    constructor(credentials){
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].config.update({
                maxRetries: 3,
                httpOptions: {
                    timeout: 30000,
            ...
            this.cloudWatchClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].CloudWatch(awsConfig);
            this.ec2Client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].EC2(awsConfig);
            this.s3Client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].S3({
                ...awsConfig,
                sslEnabled: true
            });
            this.cloudFrontClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].CloudFront(awsConfig);
            this.rdsClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].RDS(awsConfig);
            this.iamClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].IAM(awsConfig);
            this.guardDutyClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].GuardDuty(awsConfig);
    ...
    static removeInstance(credentialId) {
...
"[project]/src/lib/aws-services/ec2-security-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "EC2SecurityService": (()=>EC2SecurityService)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
;
class EC2SecurityService {
    ...
    async initialize() {
        const credential = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.findUnique({
            where: {
        ...
        const awsClient = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AwsClientManager"].getInstance(credential);
   ...
   */ async checkEC2Security() {
        await this.initialize();
        const [securityGroups, networkAcls, instances, keyPairs, volumes, iamRoles] = await Promise.all([
   ...
   */ async checkSecurityGroups() {
        ...
        for (const group of result.SecurityGroups){
            ...
            const inboundRules = (group.IpPermissions || []).map((perm)=>({
            ...
            const outboundRules = (group.IpPermissionsEgress || []).map((perm)=>({
                    protocol: perm.IpProtocol || '-1',
                    fromPort: perm.FromPort || 0,
                    toPort: perm.ToPort || 65535,
                    ipRanges: (perm.IpRanges || []).map((range)=>({
            ...
            for (const rule of inboundRules){
                ...
                if (rule.protocol === '-1' || rule.fromPort === 0 && rule.toPort === 65535) {
                    for (const ipRange of rule.ipRanges){
                        ...
                        } else if (ipRange.cidr.endsWith('/0') || ipRange.cidr.endsWith('/1') || ipRange.cidr.endsWith('/2') || ipRange.cidr.endsWith('/3') || ipRange.cidr.endsWith('/4') || ipRange.cidr.endsWith('/5') || ipRange.cidr.endsWith('/6') || ipRange.cidr.endsWith('/7') || ipRange.cidr.endsWith('/8')) {
                            issues.push({
                                type: 'WIDE_IP_RANGE',
   ...
   */ async checkNetworkACLs() {
        ...
        for (const acl of result.NetworkAcls){
            ...
            // Processar regras de entrada
            const inboundRules = (acl.Entries || []).filter((entry)=>!entry.Egress).map((entry)=>({
            ...
            // Processar regras de saída
            const outboundRules = (acl.Entries || []).filter((entry)=>entry.Egress).map((entry)=>({
                    ruleNumber: entry.RuleNumber || 0,
                    protocol: entry.Protocol || '-1',
                    action: entry.RuleAction || 'deny',
                    cidrBlock: entry.CidrBlock || '',
            ...
            for (const rule of inboundRules){
                if (rule.action === 'allow' && rule.cidrBlock === '0.0.0.0/0' && (rule.protocol === '-1' || rule.fromPort === 0 && rule.toPort === 65535)) {
                    issues.push({
                        type: 'PERMISSIVE_ACL',
   ...
   */ checkForWildcardPermissions(policyDocument) {
        if (policyDocument.Statement) {
            for (const statement of Array.isArray(policyDocument.Statement) ? policyDocument.Statement : [
   ...
   */ extractPermissions(policyDocument) {
        const permissions = [];
        if (policyDocument.Statement) {
            for (const statement of Array.isArray(policyDocument.Statement) ? policyDocument.Statement : [
                policyDocument.Statement
...
"[project]/src/lib/aws-services/vulnerability-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-client.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$ec2$2d$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-services/ec2-security-service.ts [app-route] (ecmascript)");
;
;
;
;
class VulnerabilityService {
    ...
    constructor(credentialId){
        this.credentialId = credentialId;
        this.ec2SecurityService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$ec2$2d$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EC2SecurityService"](credentialId);
    }
    async initialize() {
        const credential = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.findUnique({
            where: {
        ...
        this.rdsClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["RDS"]({
        ...
        this.s3Client = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["S3"]({
            region: credential.region,
            credentials: {
                accessKeyId: credential.accessKeyId,
                secretAccessKey: credential.secretKey
        ...
        this.dynamoClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["DynamoDB"]({
            region: credential.region,
            credentials: {
                accessKeyId: credential.accessKeyId,
                secretAccessKey: credential.secretKey
        ...
        this.lambdaClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Lambda"]({
            region: credential.region,
            credentials: {
                accessKeyId: credential.accessKeyId,
                secretAccessKey: credential.secretKey
        ...
        this.inspectorClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["Inspector"]({
            region: credential.region,
            credentials: {
                accessKeyId: credential.accessKeyId,
                secretAccessKey: credential.secretKey
   ...
   */ async scanVulnerabilities() {
        ...
        try {
            ...
            console.log("Dados de segurança EC2 obtidos:", `grupos de segurança: ${ec2SecurityData.securityGroups?.length || 0}`, `ACLs: ${ec2SecurityData.networkAcls?.length || 0}`, `instâncias: ${ec2SecurityData.instances?.length || 0}`, `volumes: ${ec2SecurityData.volumes?.length || 0}`, `IAM: ${ec2SecurityData.iamRoles?.length || 0}`);
   ...
   */ processSecurityGroupVulnerabilities(securityGroups) {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        securityGroups.forEach((sg)=>{
            if (sg.issues && sg.issues.length > 0) {
                sg.issues.forEach((issue, index)=>{
   ...
   */ processEC2InstanceVulnerabilities(instances) {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        instances.forEach((instance)=>{
            if (instance.issues && instance.issues.length > 0) {
                instance.issues.forEach((issue, index)=>{
                    const severity = this.mapSeverity(issue.severity);
                    const vuln = {
   ...
   */ processVolumeVulnerabilities(volumes) {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        volumes.forEach((volume)=>{
            if (volume.issues && volume.issues.length > 0) {
                volume.issues.forEach((issue, index)=>{
                    const severity = this.mapSeverity(issue.severity);
                    const vuln = {
   ...
   */ async processIAMRoleVulnerabilities(credentialId) {
        ...
        try {
            ...
            for (const role of Roles){
                ...
                if (AttachedPolicies && AttachedPolicies.length > 0) {
                    const hasAdminPolicy = AttachedPolicies.some((policy)=>policy.PolicyName?.includes('Admin') || policy.PolicyName?.includes('admin') || policy.PolicyName?.includes('Administrator') || policy.PolicyArn?.includes('AdministratorAccess'));
                    if (hasAdminPolicy) {
                        vulnerabilities.push({
                            id: `${id}-admin-policy`,
                            resourceId: role.RoleName,
                ...
                const { PolicyNames } = await iamClient.listRolePolicies({
                    RoleName: role.RoleName
                });
   ...
   */ checkForWidePermissions(policyJson) {
        if (!policyJson || !policyJson.Statement) {
            return false;
        }
        const statements = Array.isArray(policyJson.Statement) ? policyJson.Statement : [
        ...
        return statements.some((statement)=>{
            ...
            const hasWideActions = Array.isArray(statement.Action) ? statement.Action.some((action)=>action === '*' || action.endsWith('*')) : statement.Action === '*' || typeof statement.Action === 'string' && statement.Action.endsWith('*');
            // Verificar recursos amplos
            const hasWideResources = Array.isArray(statement.Resource) ? statement.Resource.some((resource)=>resource === '*') : statement.Resource === '*';
            return hasWideActions && hasWideResources;
        });
    }
    /**
   * Processa vulnerabilidades de Network ACLs
   */ processNetworkACLVulnerabilities(acls) {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        acls.forEach((acl)=>{
            if (acl.issues && acl.issues.length > 0) {
                acl.issues.forEach((issue, index)=>{
                    const severity = this.mapSeverity(issue.severity);
                    const vuln = {
                ...
                if (findings.findingArns && findings.findingArns.length > 0) {
                    ...
                    if (findingsDetails.findings) {
                        for (const finding of findingsDetails.findings){
                            ...
                            if (finding.assetAttributes && finding.assetAttributes.agentId && finding.assetAttributes.agentId.startsWith('i-')) {
   ...
   */ getSecurityGroupIssueTitle(type) {
        switch(type){
            case 'OPEN_SSH':
   ...
   */ getRemediationForSecurityGroupIssue(type) {
        switch(type){
            case 'OPEN_SSH':
   ...
   */ getRemediationForEC2Issue(type) {
        switch(type){
            case 'PUBLIC_IP':
   ...
   */ getRemediationForVolumeIssue(type) {
        switch(type){
            case 'UNENCRYPTED':
   ...
   */ getRemediationForIAMIssue(type) {
        switch(type){
            case 'WIDE_PERMISSIONS':
   ...
   */ getRemediationForACLIssue(type) {
        switch(type){
            case 'PERMISSIVE_ACL':
        ...
        try {
            ...
            for (const bucket of buckets){
                ...
                try {
                    ...
                    if (blockConfig && (!blockConfig.BlockPublicAcls || !blockConfig.BlockPublicPolicy || !blockConfig.IgnorePublicAcls || !blockConfig.RestrictPublicBuckets)) {
                        vulnerabilities.push({
                ...
                try {
                    const cors = await this.s3Client.getBucketCors({
                        Bucket: bucketName
                    }).promise();
   ...
   */ async scanDynamoDBVulnerabilities() {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        try {
            ...
            for (const tableName of tables){
                ...
                const tableDetails = await this.dynamoClient.describeTable({
                    TableName: tableName
                }).promise();
                ...
                try {
                    const backupDetails = await this.dynamoClient.describeContinuousBackups({
                        TableName: tableName
                    }).promise();
                    if (!backupDetails.ContinuousBackupsDescription || !backupDetails.ContinuousBackupsDescription.PointInTimeRecoveryDescription || backupDetails.ContinuousBackupsDescription.PointInTimeRecoveryDescription.PointInTimeRecoveryStatus !== 'ENABLED') {
                        vulnerabilities.push({
   ...
   */ async scanLambdaVulnerabilities() {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        try {
            ...
            let functions = [];
            do {
                const response = await this.lambdaClient.listFunctions({
                    Marker: marker
                }).promise();
   ...
   */ processAllRawSecurityIssues(ec2SecurityData) {
        const vulnerabilities = [];
        const now = new Date().toISOString();
        // Função auxiliar para processar issues genéricas
        const processIssues = (items, resourceType, prefix)=>{
            if (!items) return;
        ...
        Object.entries(ec2SecurityData).forEach(([key, value])=>{
            if (key !== 'securityGroups' && key !== 'instances' && key !== 'volumes' && key !== 'iamRoles' && key !== 'networkAcls' && Array.isArray(value)) {
                processIssues(value, key, `${key.toLowerCase()}-vuln`);
            }
        });
        return vulnerabilities;
    }
   ...
   */ removeDuplicates(vulnerabilities) {
        ...
        vulnerabilities.forEach((vuln)=>{
            ...
            if (uniqueMap.has(key)) {
                ...
                const existingSev = sevMap[existing.severity] || 0;
                const newSev = sevMap[vuln.severity] || 0;
...
"[project]/src/lib/aws-services/iam-security-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$IAMClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/IAMClient.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListUsersCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListUsersCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetUserCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/GetUserCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListAccessKeysCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListAccessKeysCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetAccessKeyLastUsedCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/GetAccessKeyLastUsedCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListGroupsForUserCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListGroupsForUserCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListAttachedUserPoliciesCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListAttachedUserPoliciesCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListAttachedGroupPoliciesCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListAttachedGroupPoliciesCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetAccountPasswordPolicyCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/GetAccountPasswordPolicyCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListGroupsCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListGroupsCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetGroupCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/GetGroupCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListPoliciesCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/ListPoliciesCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetPolicyVersionCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-iam/dist-es/commands/GetPolicyVersionCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$secrets$2d$manager$2f$dist$2d$es$2f$SecretsManagerClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-secrets-manager/dist-es/SecretsManagerClient.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$secrets$2d$manager$2f$dist$2d$es$2f$commands$2f$ListSecretsCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-secrets-manager/dist-es/commands/ListSecretsCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$secrets$2d$manager$2f$dist$2d$es$2f$commands$2f$DescribeSecretCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@aws-sdk/client-secrets-manager/dist-es/commands/DescribeSecretCommand.js [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/date-fns/formatDistanceToNow.js [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$pt$2d$BR$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/date-fns/locale/pt-BR.js [app-route] (ecmascript)");
;
;
;
;
class IAMSecurityService {
    ...
    constructor(credentials){
        ...
        this.iamClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$IAMClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["IAMClient"](clientConfig);
        this.secretsClient = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$secrets$2d$manager$2f$dist$2d$es$2f$SecretsManagerClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["SecretsManagerClient"](clientConfig);
    }
    ...
    async checkUsersWithoutMFA() {
        console.log("Verificando usuários sem MFA...");
        const issues = [];
        try {
            const listUsersCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListUsersCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListUsersCommand"]({});
            ...
            for (const user of response.Users){
                ...
                try {
                    const getUserCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetUserCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GetUserCommand"]({
    ...
    async checkExpiredAccessKeys() {
        ...
        try {
            ...
            for (const user of response.Users){
                if (!user.UserName) continue;
                try {
                    const listKeysCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListAccessKeysCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListAccessKeysCommand"]({
                        UserName: user.UserName
                    });
                    ...
                    for (const key of keysResponse.AccessKeyMetadata){
                        ...
                        const keyAge = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInDays"])(new Date(), key.CreateDate);
                        if (keyAge > MAX_AGE_DAYS) {
                            // Verificar quando foi usado pela última vez
                            try {
                                const lastUsedCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetAccessKeyLastUsedCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GetAccessKeyLastUsedCommand"]({
                                ...
                                const lastUsedText = lastUsedDate ? `Última utilização: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$formatDistanceToNow$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["formatDistanceToNow"])(lastUsedDate, {
                                    addSuffix: true,
                                    locale: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$locale$2f$pt$2d$BR$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ptBR"]
                                })}` : 'Nunca utilizada';
                                issues.push({
    ...
    async checkExpiredSecrets() {
        console.log("Verificando secrets expirados...");
        const issues = [];
        const MAX_AGE_DAYS = 90;
        try {
            const listSecretsCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$secrets$2d$manager$2f$dist$2d$es$2f$commands$2f$ListSecretsCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListSecretsCommand"]({});
            ...
            for (const secret of response.SecretList){
                ...
                try {
                    const describeSecretCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$secrets$2d$manager$2f$dist$2d$es$2f$commands$2f$DescribeSecretCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["DescribeSecretCommand"]({
                        SecretId: secret.ARN
                    });
                    ...
                    if (lastRotatedDate) {
                        const daysSinceRotation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$date$2d$fns$2f$differenceInDays$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["differenceInDays"])(new Date(), lastRotatedDate);
    ...
    async checkUsersWithAdminPermissions() {
        ...
        try {
            ...
            for (const user of response.Users){
                ...
                try {
                    ...
                    const listUserPoliciesCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListAttachedUserPoliciesCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListAttachedUserPoliciesCommand"]({
                        UserName: user.UserName
                    });
                    const userPoliciesResponse = await this.iamClient.send(listUserPoliciesCommand);
                    const userAdminPolicies = (userPoliciesResponse.AttachedPolicies || []).filter((policy)=>policy.PolicyArn && ADMIN_POLICY_ARNS.includes(policy.PolicyArn)).map((policy)=>policy.PolicyName);
                    // Verificar grupos do usuário e suas políticas
                    const listGroupsCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListGroupsForUserCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListGroupsForUserCommand"]({
                        UserName: user.UserName
                    });
                    const groupsResponse = await this.iamClient.send(listGroupsCommand);
                    const groupAdminPolicies = [];
                    if (groupsResponse.Groups && groupsResponse.Groups.length > 0) {
                        for (const group of groupsResponse.Groups){
                            ...
                            const listGroupPoliciesCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListAttachedGroupPoliciesCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListAttachedGroupPoliciesCommand"]({
    ...
    async checkPasswordPolicy() {
        ...
        const issues = [];
        try {
            const getPasswordPolicyCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetAccountPasswordPolicyCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GetAccountPasswordPolicyCommand"]({});
            try {
    ...
    async checkEmptyGroups() {
        console.log("Verificando grupos sem usuários...");
        const issues = [];
        try {
            const listGroupsCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListGroupsCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListGroupsCommand"]({});
            ...
            for (const group of response.Groups){
                if (!group.GroupName) continue;
                try {
                    const getGroupCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetGroupCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GetGroupCommand"]({
                        GroupName: group.GroupName
                    });
    ...
    async checkOverPermissivePolicies() {
        console.log("Verificando políticas muito permissivas...");
        const issues = [];
        const DANGEROUS_PATTERNS = [
            {
                pattern: '"Action": "*"',
                description: "Permissão para todas as ações"
            },
            {
                pattern: '"Action": ["*"]',
                description: "Permissão para todas as ações"
            ...
            {
                pattern: '"Action": "iam:*"',
                description: "Permissão para todas as ações do IAM"
            },
            {
                pattern: '"Action": ["iam:*"]',
                description: "Permissão para todas as ações do IAM"
        ...
        try {
            const listPoliciesCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$ListPoliciesCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["ListPoliciesCommand"]({
                Scope: "Local"
            });
            ...
            for (const policy of response.Policies){
                ...
                try {
                    const getPolicyVersionCommand = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$sdk$2f$client$2d$iam$2f$dist$2d$es$2f$commands$2f$GetPolicyVersionCommand$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["GetPolicyVersionCommand"]({
                    ...
                    if (versionResponse.PolicyVersion && versionResponse.PolicyVersion.Document) {
                        ...
                        const dangerousPatterns = DANGEROUS_PATTERNS.filter((dp)=>policyDocument.includes(dp.pattern));
...
"[project]/src/lib/alert-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "cleanupDuplicateAlerts": (()=>cleanupDuplicateAlerts),
    "createAlertFromSecurityIssue": (()=>createAlertFromSecurityIssue),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
async function createAlertFromSecurityIssue(issue, credentialId) {
    ...
    const existingAlert = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findFirst({
        where: {
            title: issue.title,
            description: issue.description,
    ...
    const createdAlert = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.create({
        data: {
            title: issue.title,
            description: issue.description,
            resourceId: issue.resourceId,
...
async function cleanupDuplicateAlerts() {
    ...
    const allAlerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findMany({
        orderBy: {
            createdAt: 'desc'
        }
    });
    ...
    if (duplicateIds.length > 0) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.deleteMany({
            where: {
                id: {
                    in: duplicateIds
                }
...
async function getAlerts(filters) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findMany({
        where: {
            ...filters?.status && {
...
async function dismissAlert(alertId) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.update({
        where: {
            id: alertId
        },
        data: {
...
"[project]/src/app/api/alerts/scan/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$vulnerability$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-services/vulnerability-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$iam$2d$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/aws-services/iam-security-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/alert-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/aws-sdk/lib/aws.js [app-route] (ecmascript)");
;
;
...
async function POST(request) {
    ...
    try {
        ...
        try {
            const sts = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$aws$2d$sdk$2f$lib$2f$aws$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].STS({
                region: credential.region,
                credentials: {
                    accessKeyId: credential.accessKeyId,
                    secretAccessKey: credential.secretKey
        ...
        const scanPromise = Promise.allSettled([
            ...
            (async ()=>{
                try {
                    ...
                    const iamSecurityService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$iam$2d$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IAMSecurityService"]({
                        id: credential.id,
                    ...
                    let existingAlerts = {};
                    if (skipExisting) {
                        const alerts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].alert.findMany({
                            where: {
                                resourceType: {
                                    in: [
                                        'IAMUser',
                    ...
                    for (const issue of securityIssues){
                        ...
                        const alert = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$alert$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAlertFromSecurityIssue"])(securityIssue, credentialId);
            ...
            (async ()=>{
                try {
                    ...
                    const vulnerabilityService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$aws$2d$services$2f$vulnerability$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["VulnerabilityService"](credentialId);
                    const vulnerabilities = await vulnerabilityService.scanVulnerabilities();
                    // Filtrar apenas vulnerabilidades relacionadas ao EC2
                    const ec2Vulnerabilities = vulnerabilities.filter((v)=>v.resourceType === 'EC2Instance' || v.resourceType === 'SecurityGroup' || v.resourceType === 'Volume' || v.resourceType.includes('VPC') || v.resourceType.includes('Network') || v.resourceType === 'NetworkACL' || v.resourceType.includes('ACL') || v.resourceType === 'ElasticIP' || v.resourceType === 'RouteTable' || v.resourceType === 'Subnet');
        ...
        if (error instanceof Error) {
            ...
            if (error.name === 'AccessDeniedException') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    error: 'Acesso negado. Verifique as permissões da credencial AWS'
                }, {
                    status: 403
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8fcbf3c1._.js.map