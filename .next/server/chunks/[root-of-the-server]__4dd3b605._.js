...
"[project]/src/lib/repositories/aws-credential-repository.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class AwsCredentialRepository {
    ...
    async create(data) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.create({
            data
        });
    }
    async update(id, data) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.update({
            where: {
                id
            },
            data
    ...
    async delete(id) {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].awsCredential.delete({
            where: {
                id
            }
        });
...
"[project]/src/lib/services/ec2-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$repositories$2f$aws$2d$credential$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/repositories/aws-credential-repository.ts [app-route] (ecmascript)");
;
;
class EC2Service {
    ...
    cacheTTL = 3 * 60 * 1000;
    constructor(){
        this.credentialRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$repositories$2f$aws$2d$credential$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AwsCredentialRepository"]();
    }
    async getInstances(credentialId) {
        ...
        try {
            ...
            const instances = result.Reservations?.flatMap((reservation)=>reservation.Instances?.map((instance)=>({
...
"[project]/src/lib/services/iam-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class IAMService {
        ...
        try {
            ...
            const userPromises = listUsersResult.Users.map(async (user)=>{
                try {
                    ...
                    const [policiesResult, loginProfileResult, mfaDevicesResult, accessKeysResult] = await Promise.all([
    ...
    calculateRiskLevel(hasConsoleAccess, hasMfa, accessKeysCount) {
...
"[project]/src/lib/services/s3-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/services/security-service.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
class SecurityService {
    ...
    async getSecurityIssues(credentialId) {
    ...
    async checkGuardDutyIssues(awsClient, securityIssues) {
        try {
    ...
    async checkS3SecurityIssues(awsClient, securityIssues) {
        try {
            const s3Client = awsClient.getS3Client();
            ...
            if (Buckets) {
                const checks = Buckets.map(async (bucket)=>{
                    try {
                        const bucketPolicy = await s3Client.getBucketPolicy({
                            Bucket: bucket.Name || ''
                        }).promise();
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$repositories$2f$aws$2d$credential$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/repositories/aws-credential-repository.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$ec2$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/ec2-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$iam$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/iam-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$s3$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/s3-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/services/security-service.ts [app-route] (ecmascript)");
;
;
;
;
;
;
const awsCredentialRepository = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$repositories$2f$aws$2d$credential$2d$repository$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AwsCredentialRepository"]();
const ec2Service = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$ec2$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["EC2Service"]();
const iamService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$iam$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IAMService"]();
const s3Service = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$s3$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["S3Service"]();
const securityService = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$security$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["SecurityService"]();
...
async function getIAMService(credentialId) {
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$services$2f$iam$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["IAMService"](credential);
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4dd3b605._.js.map